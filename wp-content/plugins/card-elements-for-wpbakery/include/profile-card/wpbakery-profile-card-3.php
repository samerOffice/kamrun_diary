<?php
/**
 * HTML css for Profile card style 3
 * 
 * @version 1.0
 * @since 1.0
*/
...
<div class="profile-card-style-3 <?php echo esc_attr('profile_card_class_'.$custom_uniq_class); ?>" style="background-image:url(<?php echo esc_url($cewb_profile_background_image); ?>);">
    <div class="team-member profile-background-dynamic-style">
        ...
        <div class="team-member__info">
            ...
            <?php } ?>    
            <h4 class="profile-name profile-name-dynamic-style " style="font-family: <?php echo esc_attr($google_fonts_family_for_name[0]); ?>;font-weight: <?php echo esc_attr($google_fonts_styles_for_name[1]); ?>;  font-style: <?php echo esc_attr($google_fonts_styles_for_name[2]); ?>;"><?php esc_html_e($cewb_profile_name ); ?></h4>
...
<style>
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-name-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-position-dynamic-style{
    ...
    .profile_card_class_<?php echo $custom_uniq_class ; ?>.profile-card-style-3 .profile-description-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-background-dynamic-style{
        background : <?php echo esc_attr($cewb_profile_card_style_background_color ); ?>;
    }
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-social-background-dynamic-style{
        background : <?php echo esc_attr($cewb_profile_card_style_social_background_color); ?>;
    }
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-social-icon-background-dynamic-style{
    ...
    .profile_card_class_<?php echo $custom_uniq_class ; ?>.profile-card-style-3 .profile-social-icon-color-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-social-background-dynamic-style:hover{
        background : <?php echo esc_attr($cewb_profile_card_style_social_hover_background_color); ?>;
    }
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-social-icon-background-dynamic-style:hover{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class ); ?>.profile-card-style-3 .profile-social-icon-color-dynamic-style:hover{
