...
<div class="profile-card-style-2 <?php echo esc_attr('profile_card_class_'.$custom_uniq_class); ?>" style="background-image:url(<?php echo esc_url($cewb_profile_background_image); ?>);">
...
<style>
    ...
    .profile_card_class_<?php echo $custom_uniq_class ; ?>.profile-card-style-2 .profile-social-icon-background-dynamic-style:hover{
        background : <?php echo $cewb_profile_card_style_social_icon_hover_background_color.'!important'; ?>;
        border-radius : <?php echo $cewb_profile_card_social_icon_hover_box_radius ; ?>;
    }
    .profile_card_class_<?php echo $custom_uniq_class ; ?>.profile-card-style-2 .profile-social-icon-color-dynamic-style:hover{
        color : <?php echo $cewb_profile_card_style_social_icon_hover_color ; ?>;
    }
