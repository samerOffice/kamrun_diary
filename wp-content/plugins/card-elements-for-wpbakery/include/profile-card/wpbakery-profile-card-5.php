<?php
/**
 * HTML css for Profile card style 5
 * 
 * @version 1.0
 * @since 1.0
*/
...
<div class="profile-card-style-5 text-center <?php echo 'profile_card_class_'.esc_attr($custom_uniq_class); ?>" style="background-image:url(<?php echo esc_attr($cewb_profile_background_image);  ?>);">
    <div id="ct-team-member-2" class="ct-team-member-layout">
        <div class="ct-team-member-inner profile-background-dynamic-style">
            <div class="ct-team-image">
                <img src="<?php echo esc_attr($cewb_profile_image);  ?>" width="255" height="320"class="img img-responsive">
                <?php if( $cewb_social_icon_value === 'true'){ ?>
                    <div class="wpbakery-social-icons-wrapper ct-team-social  ">
                        ...
                        <?php if (!empty($cewb_social_facebook_icon)) { ?>
                            <div class="social-icon-div profile-social-background-dynamic-style">
            ...
            <div class="ct-team-holder">
                <h3 class="ct-team-title profile-name profile-name-dynamic-style" style="font-family: <?php echo esc_attr($google_fonts_family_for_name[0]); ?>;font-weight: <?php echo esc_attr($google_fonts_styles_for_name[1]); ?>;  font-style: <?php echo esc_attr($google_fonts_styles_for_name[2]); ?>;"><?php  esc_html_e($cewb_profile_name ); ?></h3>
                <div class="ct-team-position profile-position profile-position-dynamic-style" style="font-family: <?php echo esc_attr($google_fonts_family_for_pos[0]); ?>;font-weight: <?php echo esc_attr($google_fonts_styles_for_pos[1]); ?>; font-style: <?php echo esc_attr($google_fonts_styles_for_pos[2]); ?>;">
                    <?php esc_html_e($cewb_profile_position); ?>
                </div>
            </div>
        </div>
    </div>
...
<style>
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-name-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-position-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-description-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-background-dynamic-style{
        background : <?php echo esc_attr($cewb_profile_card_style_background_color) ; ?>;
    }
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-social-background-dynamic-style {
        background : <?php echo $cewb_profile_card_style_social_background_color; ?>;
    }
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-social-icon-background-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-social-icon-color-dynamic-style{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-social-background-dynamic-style:hover{
        background : <?php echo esc_attr($cewb_profile_card_style_social_hover_background_color); ?>;
    }
    .profile_card_class_<?php echo $custom_uniq_class ; ?>.profile-card-style-5 .profile-social-icon-background-dynamic-style:hover{
    ...
    .profile_card_class_<?php echo esc_attr($custom_uniq_class) ; ?>.profile-card-style-5 .profile-social-icon-color-dynamic-style:hover{
